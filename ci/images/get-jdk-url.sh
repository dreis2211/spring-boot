...
case "$1" in
	...
	;;
	java14)
		 echo "https://github.com/AdoptOpenJDK/openjdk14-binaries/releases/download/jdk14-2020-02-26-04-25/OpenJDK14-jdk_x64_linux_hotspot_2020-02-26-04-25.tar.gz"
	;;
  *)
